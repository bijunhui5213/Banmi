...
import com.example.youfeadaway.banmi.activity.MainActivity;
import com.example.youfeadaway.banmi.utils.SpUtil;

public class UpNameActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mEtName.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (s.length() >= 30) {
                    Toast.makeText(UpNameActivity.this, "抱歉您输入的字数太多了，请控制在30字以内", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_finish:
                ...
                if (!upname.isEmpty()) {
                    ...
                    SpUtil.setParam("upname",upname);
                    setResult(2, intent);
                    Toast.makeText(UpNameActivity.this, "修改成功", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(UpNameActivity.this, "请输入您的昵称", Toast.LENGTH_SHORT).show();
                }
